...
- [《Redis开发与运维》笔记](https://juejin.im/post/5b1a541e5188257d9e5f7c8a)

- [Redis Sentinel 搭建](https://www.jianshu.com/p/d1853dc1b70a)
...
- [深入分析JVM逃逸分析对性能的影响](https://www.jianshu.com/p/04fcd0ea5af7)

- [线上Java 高CPU占用、高内存占用排查思路](https://blog.csdn.net/baiye_xing/article/details/90483169)

- [java -Xms -Xmx设置java应用程序运行的内存大小，Xms Xmx PermSize MaxPermSize 区别](https://blog.csdn.net/u011930016/article/details/49422433)

- [JVM -- 分析Dump文件定位OOM问题](https://www.jianshu.com/p/8f1679d9603b)

- [jvm：内存模型、内存分配及GC垃圾回收机制](https://juejin.im/post/5d44f4f7e51d4561d923ccda#heading-24)
...
- [Synchronized到底锁住的是谁？](https://juejin.im/post/5d0c8101e51d455a694f954a)

- [InheritableThreadLocal 用法](https://juejin.im/post/5d15d36df265da1bc37f229a)

- [【Java并发】ReadWriteLock读写锁的使用](https://www.jianshu.com/p/9cd5212c8841)

- [啃碎并发（七）：深入分析Synchronized原理](https://juejin.im/post/5b4eec7df265da0fa00a118f#heading-16)

- [记一次 JVM 源码分析(3.内存管理与GC)](https://blog.csdn.net/ganyao939543405/article/details/83795625)

- [【Java并发】ReadWriteLock读写锁的使用](https://www.jianshu.com/p/9cd5212c8841)

- [并发编程的锁机制：synchronized和lock](https://juejin.im/post/5a43ad786fb9a0450909cb5f#comment)

- [ThreadLocal就是这么简单](https://juejin.im/post/5ac2eb52518825555e5e06ee)

- [CountdownLatch和CyclicBarrier的区别使用场景与具体实现](https://juejin.im/post/5dc25cb95188255fbd1667dc)
...
- [Spring自定义注解从入门到精通](https://juejin.im/post/5cf376e16fb9a07eee5eb6eb)
...
- [接口限流算法：漏桶算法&令牌桶算法](https://zhuanlan.zhihu.com/p/68733735)
